try:
    ...
    def type(s):
      print(s)
      d={'R':['0110011'],'I':['0000011','0010011','1100111'],'S':['0100011'],'B':['1100011'],'J':['1101111'],'mul':'1110111','rst':'0000000','halt':'1111111','rvrs':'0001000'}
      for i in d:
        for j in d[i]:
            if j==s:
                return i
    ...
    def Rtype(s):
        d={'000':'add','010':'slt','101':'srl','110':'or','111':'and','001':'mul'}
    ...
    with open(r'C:\Users\KANAK GUPTA\OneDrive\Documents\CO\input.txt','r') as f:
        r=f.read().split('\n')
        print(r)
        c=0
        n=1
        ...
        while True:
            ...
            if i=='00000000000000000000000001100011':
                break 
        with open(r'C:\Users\KANAK GUPTA\OneDrive\Documents\CO\output0.txt','w') as g:
             da_me_0=da_me_1=''
             print(dm)
             for i in dm:
        ...
        with open(r'C:\Users\KANAK GUPTA\OneDrive\Documents\CO\output1.txt','w') as h:
